  ...
  const About = () => {
    const visiMisi = {
      visi: "Menjadi rumah kedua yang penuh kasih, nyaman, dan mendukung lansia untuk tetap sehat, bahagia, dan bermartabat.",
      misi: [
        "Memberikan perawatan holistik dengan cinta dan perhatian.",
        "Menyediakan nutrisi seimbang dan pemeriksaan kesehatan rutin.",
        "Menciptakan lingkungan yang mendukung kemandirian lansia.",
        "Memberikan ruang untuk aktivitas rekreasi dan sosial.",
      ],
    };

    const strukturOrganisasi = {
      kepala: { role: "Kepala Panti", name: "Siti Rahma" },
      wakil: { role: "Wakil Kepala", name: "Ahmad Fauzi" },
      tim: [
        { role: "Dokter", name: "dr. Indah Lestari" },
        { role: "Perawat", name: "Maya Sari" },
        { role: "Gizi", name: "Dian Kusuma" },
        { role: "Administrasi", name: "Rahmat Hidayat" },
      ],
    };
    ...
    return (
      <div className="relative overflow-hidden">
        ...
        <div className="relative z-10 min-h-screen py-16 px-4 sm:px-8 md:px-16 lg:px-32">
          ...
          >
            Tentang Panti Jompo Harapan Sejahtera
          </motion.h1>
